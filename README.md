...
```
docker run -it --privileged --rm --net=host -v /dev/shm:/dev/shm -v $(pwd):/protractor piotrovskyi/protractor-headless [protractor options]
```
...
docker run -it --privileged --rm --net=host -v /dev/shm:/dev/shm -v $(pwd):/protractor piotrovskyi/protractor-headless $@
```
...
```
docker run -it --privileged --rm --net=host --shm-size 2g -v $(pwd):/protractor piotrovskyi/protractor-headless [protractor options]
```
...
```
docker run -it --privileged --rm --net=host -e SCREEN_RES=1920x1080x24 -v /dev/shm:/dev/shm -v $(pwd):/protractor piotrovskyi/protractor-headless [protractor options]
```
